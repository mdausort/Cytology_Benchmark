...
# --- launch code ---
python3 run.py \
  --log_path ./Cytology_Benchmark/output/${DATASET}/CLIP-LoRA/${ENCODER}_feat/${MODEL_NAME}/${SHOT}shots/seed${SEED} \
  --seed ${SEED} \
  --shots ${SHOT} \
  --lr 0.001 \
  --n_epochs 100 \
  ...
  --backbone ${BACKBONE} \
  --r 0 \
  --results_path ./Cytology_Benchmark/output/${DATASET}/CLIP-LoRA/${ENCODER}_feat/${MODEL_NAME}/${SHOT}shots/seed${SEED}
