...
DIR=/gpfs/projects/acad/coalap/mdausort/ISBI_sup/output_debug/${DATASET}/${TRAINER}/${CFG}/${SHOTS}shots/${N_CTX_VISION}nctxv_dv${PROMPT_DEPTH_VISION}_${N_CTX_TEXT}nctxt_dt${PROMPT_DEPTH_TEXT}/seed${SEED}
LOGFILE="${DIR}/log.txt"
