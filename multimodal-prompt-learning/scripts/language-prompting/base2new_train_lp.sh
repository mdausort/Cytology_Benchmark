...
#SBATCH --output="/gpfs/projects/acad/coalap/mdausort/ISBI_sup/logs_ivlp/tpt_%A_%a.out"
#SBATCH --error="/gpfs/projects/acad/coalap/mdausort/ISBI_sup/logs_ivlp/tpt_%A_%a.err"
...
# 4) grids (arrays)
DATASETS=(bcfc bloodmnist bmcd bmt eurosat fnac2019 herlev hicervix mlcc sipakmed)  #  bloodmnist bmcd bmt eurosat fnac2019 herlev hicervix mlcc sipakmed
CFGS=(conch_b16 vit_b16 vit_b32 biomedclip_b16 quilt_b16 quilt_b32 plip_b32 pubmedclip_b32)
