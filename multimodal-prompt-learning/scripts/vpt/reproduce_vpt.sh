...
# 4) grids (arrays)
DATASETS=(hicervix apacc)
CFGS=(vit_b16 vit_b32 biomedclip_b16 conch_b16 plip_b32 pubmedclip_b32 quilt_b16 quilt_b32 dinobloom-s dinobloom-b)
...
DIR=/gpfs/projects/acad/coalap/mdausort/ISBI_sup/output/${DATASET}/${TRAINER}/${CFG}/${SHOTS}shots/${N_CTX_VISION}nctxv_dv${PROMPT_DEPTH_VISION}/seed${SEED}
LOGFILE="${DIR}/log.txt"
